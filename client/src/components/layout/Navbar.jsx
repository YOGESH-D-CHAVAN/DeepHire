...
const Navbar = ({ onMenuClick }) => {
  return (
    <nav className="h-16 border-b border-white/10 bg-[#0a0a0a]/80 backdrop-blur-md sticky top-0 z-50 px-4 md:px-6 flex items-center justify-between">
      {/* Branding */}
      <div className="flex items-center gap-4">
        ...
        <span className="text-[10px] font-medium text-white/30 uppercase tracking-[0.2em] hidden lg:block">
      ...
      <div className="flex items-center gap-2 md:gap-4">
        ...
        <div className="flex items-center gap-3 pl-1 md:pl-2">
          ...
          <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-gradient-to-br from-cyan-500 to-violet-600 p-[2px] cursor-pointer hover:scale-105 transition-transform">
